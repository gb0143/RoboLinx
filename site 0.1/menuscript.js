...
subInfo[1][1] = new Array("Sub-Button 1","https://www.google.com/","fun");
subInfo[1][2] = new Array("Sub-Button 2","https://www.facebook.com/","fun");

subInfo[2][1] = new Array("Sub-Button 1","Sub-Link 1","fun");
subInfo[2][2] = new Array("Sub-Button 2","Sub-Link 2","fun");
subInfo[2][3] = new Array("Sub-Button 3","Sub-Link 3","fun");

subInfo[3][1] = new Array("Sub-Button 1","Sub-Link 1","fun");
subInfo[3][2] = new Array("Sub-Button 2","Sub-Link 2","fun");
