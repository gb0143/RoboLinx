		...
		<div class="page">
			...
			<div class="body home">
				<div>
					...
					<span><center><h1>Pages of search results will go here!</h1></center></span>
				</div>
				<div class="sidebar">
				<div id='search' class = 'search'>
				<span>
				<input type='text' id='search' value='search' style="font-size: 15pt; width:170px; padding: 0 0 0 0;"/>
